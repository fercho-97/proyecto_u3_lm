...
public class Transferencia {
	...
	private CuentaBancaria cuentaBancariaDetino;
	...
	public CuentaBancaria getCuentaBancariaDetino() {
		return cuentaBancariaDetino;
	}

	public void setCuentaBancariaDetino(CuentaBancaria cuentaBancariaDetino) {
		this.cuentaBancariaDetino = cuentaBancariaDetino;
	}
